...
(function (e) {
    ...
    l.prototype = {constructor: l, listen: function () {
        ...
        var t = this;
        var n = t.$element, r = n.get(0).files, i = r ? r.length : 1, s = n.val().replace(/\\/g, "index-2.html").replace(/.*\//, ""), o = t.$preview, f = t.$previewContainer, l = t.$previewStatus, c = t.msgLoading, h = t.msgProgress, p = t.msgSelected, d, v = t.previewFileType, m = parseInt(t.wrapTextLength), g = t.wrapIndicator;
