...
<!-- Mirrored from fickle.aimmate.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Jan 2015 18:03:45 GMT -->
<head>
    <meta charset="utf-8">
...
<!--Left navigation start-->
    <ul class="mainNav">
        ...
        <li>
            <a href="{{ route('stageadd') }}">
                <i class="fa fa-table"></i> <span>Stage</span>
            </a>
        </li>
        <li>
            <a href="notification.html">
                <i class="fa fa-bullhorn"></i> <span>Offres d'emploi</span>
            </a>
        </li>
        <li>
            <a href="notification.html">
                <i class="fa fa-bullhorn"></i> <span>Evénements</span>
            </a>
        </li>
        {{--<li>--}}
...
<!-- Mirrored from fickle.aimmate.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Jan 2015 18:04:29 GMT -->
</html>