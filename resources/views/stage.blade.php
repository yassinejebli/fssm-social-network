...
<!-- Mirrored from fickle.aimmate.com/sample-form.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Jan 2015 18:05:24 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <section id="main-container">
        ...
        <section id="left-navigation">
            ...
            <li class="active">
                ...
                <ul>
                    <li><a class="active" href="sample-form.html">Formulaire</a></li>
            ...
            <div id="main-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <!--Top header start-->
                            <h3 class="ls-top-header">Nouveau Stage</h3>
                            <!--Top header end -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Inline Level</h3>
                                </div>
                                <div class="panel-body">
                                ...
                                <div class="panel-body">
                                    <form action="#" class="form-horizontal ls_form">
                                        ...
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Rounded</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control rounded" name="rounded_text">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">With help text</label>
                                                <div class="col-md-10">
                                        ...
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Focus Input</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="active_focus" class="form-control active">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="password" name="password" class="form-control" value="c0mm0n!@#">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Place Holder</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="placeholder" class="form-control" placeholder="Beautiful placeholder">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ls_divider last">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" disabled="" name="Disabled" placeholder="Disabled input here..." class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Validation Ui</h3>
                                </div>
                                <div class="panel-body">
                                    <form action="#" class="message-form ls_form" enctype="multipart/form-data">
                                        <div class="row ls_divider">
                                ...
                                <div class="panel-body">
                                    <form action="#" class="form-horizontal ls_form" enctype="multipart/form-data">
                                        <div class="row ls_divider">
                                            ...
                                            <div class="col-md-10 ls-group-input">
                                                <textarea class="form-control" id="bio1" name="bio1"
                                                          placeholder="Placeholder"></textarea>
                                            </div>
                                        </div>
                                        <div class="row ls_divider last">
                                            <label class="col-md-2 control-label">Resize</label>

                                            <div class="col-md-10 ls-group-input">
                                                <textarea class="animatedTextArea form-control " id="bio" name="bio"
                                                          placeholder="With animation :)"></textarea>
                                                <span class="help_text">Auto Resize textarea</span>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="#" class="form-horizontal ls_form">
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Sizing</label>
                                                <div class="col-md-10">
                                                    <input type="text" name="input-lg" placeholder=".input-lg" class="form-control input-lg ls-group-input">
                                                    <input type="text" name="Default" placeholder="Default input" class="form-control ls-group-input">
                                                    <input type="text" name="input-sm" placeholder=".input-sm" class="form-control input-sm">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-6">
                                                            <input type="text" placeholder=".col-md-3 .col-md-6" class="form-control ls-group-input">
                                                        </div>
                                                        <div class="col-md-3 col-sm-6">
                                                            <input type="text" placeholder=".col-md-3 .col-md-6" class="form-control ls-group-input">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 col-sm-6">
                                                            <input type="text" placeholder=".col-md-4 col-sm-6" class="form-control ls-group-input">
                                                        </div>
                                                        <div class="col-md-4 col-sm-6">
                                                            <input type="text" placeholder=".col-md-4 .col-sm-6" class="form-control ls-group-input">
                                                        </div>
                                                        <div class="col-md-4 col-sm-12">
                                                            <input type="text" placeholder=".col-md-4 .col-sm-12" class="form-control ls-group-input">
                                                        </div>
                                                    </div>

                                                    <div class="row">
                                                        <div class="col-md-6 col-sm-6">
                                                            <input type="text" placeholder=".col-md-2 .col-sm-6" class="form-control ls-group-input">
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <input type="text" placeholder=".col-md-2 .col-sm-6" class="form-control ls-group-input">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-1 col-sm-4">
                                                            <input type="text" placeholder=".col-md-1 .col-sm-4" class="form-control ls-group-input">
                                                        </div>
                                                        <div class="col-md-2 col-sm-4">
                                                            <input type="text" placeholder=".col-md-2 .col-sm-4" class="form-control ls-group-input">
                                                        </div>
                                                        <div class="col-md-6 col-sm-4">
                                                            <input type="text" placeholder=".col-md-6 .col-sm-4" class="form-control ls-group-input">
                                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="#" class="form-horizontal ls_form">
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Groups input</label>
                                        ...
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Groups Dropdown</label>
                                        ...
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Segmented</label>
                                        ...
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Addons button </label>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="#" class="form-horizontal ls_form">
                                        <div class="row ls_divider">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Default select</label>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="#" class="form-horizontal ls_form">
                                        <div class="row ls_divider last">
                                            <div class="form-group">
                                                <label class="col-md-2 col-sm-2 col-xs-12 control-label">Default Radio</label>
                                                ...
                                                <div class="col-md-5 col-sm-5 col-xs-12 ls-group-input">
                                                    <div class="radio-inline">
                                                        ...
                                                        <p class="preview-advance">
                                                            <a href="checkbox-radio.html">Advance Radio</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form action="#" class="form-horizontal ls_form">
                                        <div class="row ls_divider last ">
                                            <div class="form-group">
                                                <label class="col-md-2 col-sm-2 col-xs-12 control-label">Default Checkbox</label>

                                                <div class="col-md-5 col-sm-5 col-xs-12 ls-group-input">
                                                    <label class="checkbox">
                                                        <input type="checkbox" id="inlineCheckbox1" value="option1"> Option one
                                                    </label>
                                                    <label class="checkbox">
                                                        <input type="checkbox" id="inlineCheckbox2" value="option2"> Option two
                                                    </label>
                                                </div>
                                                <div class="col-md-5 col-sm-5 col-xs-12 ls-group-input">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" id="inlineCheckbox4" value="option1"> Option one
                                                    </label>
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" id="inlineCheckbox5" value="option2"> Option two
                                                    </label>
                                                    <p class="preview-advance">
                                                        <a href="checkbox-radio.html">Advance Checkbox</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
...
<!-- Mirrored from fickle.aimmate.com/sample-form.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Jan 2015 18:05:25 GMT -->
</html>